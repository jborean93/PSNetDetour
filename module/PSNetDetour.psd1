...
#
# Module manifest for module 'PSNetDetour'
#
...
@{
    ...
    GUID              = '7ccd04da-e8b0-4ec7-938e-13940a6a0b6c'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/jborean93/PSNetDetour/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/jborean93/PSNetDetour'

            # A URL to an icon representing this module.
            # IconUri = ''

            # ReleaseNotes of this module
            ReleaseNotes = 'See https://github.com/jborean93/PSNetDetour/blob/main/CHANGELOG.md'
